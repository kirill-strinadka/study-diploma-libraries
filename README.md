...
1. **[Slide](./doc/Slide.md) (абстрактный базовый класс)**
...
3. **[SlideLibrary](./doc/SlideLibrary.md) (управление слайдами)**
    ...
    - Умеет динамически подгружать новые типы слайдов
...
5. **UIManager и ToolManager (управление интерфейсом)**
    - Принимают на вход html элементы, в которых будет отображаться слайд и его панель инстурментов.
    - Обеспечивают взаимодействие пользователя с инструментами и контейнерами слайдов.
    - ToolManager хранит панель инструментов, специфичную для каждого типа слайда.
